...
public class TourAPI_Test {
    public static void main(String[] args) {
    	//Client로부터 받아온 Ip를 변수에 저
    	String mapX = "126.7338";
    	String mapY = "37.3400";
    	...
    	try {
            ...
            if(item.size() > 0) {
            	for(int i = 0; i < item.size(); i++) {
                    ...
                    System.out.println("주소1 : " + tourInfor.get("addr1"));
                    System.out.println("거리 : " + tourInfor.get("dist"));
                    System.out.println("전화번호 : " + tourInfor.get("tel"));
                    System.out.println("관광지명 : " + tourInfor.get("title"));
                    System.out.println();
            	}
            }          
            conn.disconnect();
