...
public class SharedArea {
    ...
    public static String tologin_msg="로그인 모듈로 전달할 메시지가 저장되지 않았습니다"; //클라이언트가 로그인 모듈로 보내는 메시지를 저장
    public static String replylogin_msg="로그인 모듈의 응답메시지가 저장되지 않았습니다"; //로그인 모듈이 요청을 보냈던 클라이언트에게 보내는 메시지를 저장
